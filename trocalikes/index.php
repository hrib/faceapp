...
if (! isset($accessToken)) {
  ...
  echo "<input type='button' style='background: url(facebook-login.png);  width:400px; height:50px; background-size: 390px 40px; background-repeat: no-repeat;'  value='' onClick='logar();'>";
  echo '<br>';
	echo '<br>';
echo "<input type='button' style='background: url(facebook-login.png); width:400px; height:50px; background-size: 395px 40px; background-repeat: no-repeat; '  value='' onClick='logar();'>";
  echo '<br>';
	echo '<br>';
	echo "<input type='button' style='background: url(facebook-login.png); width:400px; height:50px; background-size: 380px 45px; background-repeat: no-repeat; '  value='' onClick='logar();'>";
